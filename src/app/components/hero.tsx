...
export default function Hero() {
  ...
  return (
    <section className="mx-auto w-full h-screen relative overflow-hidden px-4">
      <div className="">
        <CircularText
        ...
        <div
          className={`max-w-6xl max-xl:max-w-5xl mx-auto 
         rounded-3xl max-lg:rounded-none absolute top-1/2 tra left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden w-full h-[500px]`}
        >
